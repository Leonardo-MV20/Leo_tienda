...
import Leo_tienda.tienda.domain.Producto;
...
public interface ProductoRepository extends JpaRepository<Producto, Integer> {
    ...
    @Query(nativeQuery = true,
            value = "SELECT * FROM producto p WHERE p.id_categoria = :idCategoria ORDER BY p.precio ASC")
    public List<Producto> consultaSQLCategoria(@Param("idCategoria") int idCategoria);
